...
- Landing and dashboard surfaces now use a Stripe-inspired gradient theme driven by shared tokens and animations in `app/globals.css`.
...
- `modules/dashboard/App.tsx`: client dashboard shell with Stripe gradients and analytics modules
